...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">عام</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الأسئلة الشائعة</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@endif
            ...
            <div class="card-header pb-0">
                <div class="card-header pb-0">
                    ...
                    data-toggle="modal" href="#modaldemo8"><i
                            class="fas fa-plus"></i>&nbsp; اضافة سؤال جديد</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-outline-success btn-sm"
                                                    ...
                                                    data-answer="{{ $question->answer }}" data-toggle="modal"
                                                    data-target="#exampleModal2">تعديل</button>
                                            
                                                <button class="btn btn-outline-danger btn-sm " data-id="{{ $question->id }}"
                                                 data-toggle="modal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">اضافة سؤال جديد</h6><button aria-label="Close" class="close" data-dismiss="modal"
    ...
    <div class="modal" id="modaldemo9">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">حذف السؤال</h6><button aria-label="Close" class="close" data-dismiss="modal"
                        type="button"><span aria-hidden="true">&times;</span></button>
                </div>
